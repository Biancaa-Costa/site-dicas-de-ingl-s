...
<link rel="shortcut icon icon" href="favicon.ico" type="image/x-icon">
        
    <title>Dicas de inglês</title>
...
<body>
    ...
    <ul>
        ...
        <li>Sorry-Desculpe</li>
        <li>Thank you-Obrigado(a)</li>
    </ul>
    <p>
        <a href='' https: //www.youtube.com/@DicasdaBiancaLanguageTips" target="_blank">Visit my YouTube channel</a>
        <br /> <img src="viagem.png" alt="itens de viagem " />
        <!--comentário-->
